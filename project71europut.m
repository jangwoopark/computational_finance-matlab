...
bsp=BinomialAmerican(0,S,K,r,0,T,v,N);

%.2*sqrt(.002)=.0089 .2*sqrt(3*.002)=.0155 .2*sqrt(4*.002)=.0179
cneu=CrankNicolsonEuro(0,S,K,r,0,T,v,0,30,.5,.002)
ifdeu=ImplicitEuro(0,S,K,r,0,T,v,0,30,.5,.002)
efdeu=(cneu-ifdeu)+cneu
